...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-evenly max-sm:flex-col backdrop-blur-2xl'>
...
//             <p className='text-sm text-gray-600'>
//               Create an account{" "}
//               <span onClick={() => { setCurrState("signup"); setIsDataSubmitted(false); }} className='font-medium text-violet-500 cursor-pointer'>
//                 Click here
//               </span>
//             </p>
//           )}

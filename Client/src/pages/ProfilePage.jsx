  ...
  return (
    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
     ...
     <form className='flex flex-col gap-5 p-10 flex-1'>
      <h3 onChange={handleSubmit} className='text-lg'>Profile details</h3>
      ...
      placeholder='Write profile bio' required className='p-2 border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500' rows={4}></textarea>

...
//   // const filteredUsers = input ? users.filters((user)=>user.fullName.toLowerCase().includes(input.toLowerCase())) : users;
...
const SideBar = () => {
  ...
  // Filter users based on input (case insensitive)
  ...
  // Fetch users on component mount and when onlineUsers change
  useEffect(() => {
    getUsers()

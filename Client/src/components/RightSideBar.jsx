...
//           <p>Media</p>
//           <div className='mt-2 max-h-[200px] overflow-h-scroll grid grid-cols-2 gap-4 opacity-80'>
...
const RightSideBar = () => {
  ...
  if (Array.isArray(messages)) {
    const images = messages
      .filter(msg => msg && msg.image) // ensure msg is not undefined and has image
      .map(msg => msg.image)
    setMsgImages(images)
  } else {
    setMsgImages([]) // fallback if messages is undefined or not an array
  }
}, [messages])
